...
namespace FutureWorldStore.Models
{
    ...
    class DBMain
    {
        ...
        string connAdmin = @"Data Source=QUANGHUY;Initial Catalog=PMBanDienThoai;User ID=admin1;Password=123";
        string connSeller = @"Data Source=QUANGHUY;Initial Catalog=PMBanDienThoai;User ID=seller1;Password=123";
